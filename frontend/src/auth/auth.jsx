...
import Grid from '../common/layout/row'
        ...
        return (
            <div className="login-box">
                ...
                <div className="login-box-body">
                    ...
                    <form onSubmit={handleSubmit(v => this.onSubmit())}>
                        <Field component={Input} type="input" name="name"
                            placeholder="Nome" icon="user" hide={loginMode} />
                        <Field component={Input} type="email" name="email"
                            placeholder="E-mail" icon="envelope" hide={loginMode} />                            
                        <Field component={Input} type="password" name="password"
                            placeholder="Senha" icon="lock" hide={loginMode} />
                        <Field component={Input} type="password" name="confirm-password"
